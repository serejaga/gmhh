...
AddBackstory( "Separatist", "Born into culture oppressed by an occupying power, %s grew up witnessing injustices inflicted upon their people.", gm.models.badboyz, { "bb_p228_alt" } ) 
AddBackstory( "Terrorist", "%s backstory is complex, often rooted in personal trauma, political oppression, or profound sense of injustice. They may have been radicalized by charismatic leader or through exposure to violence and hardship.", gm.models.badboyz, { "bb_mac10_alt", "bb_css_knife_alt" } ) 
